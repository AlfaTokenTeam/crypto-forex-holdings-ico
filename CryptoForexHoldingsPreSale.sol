...
import "./CryptoForexHoldings.sol";

contract CryptoForexHoldingsPreSale {
    CryptoForexHoldings public token;
    ...
    function CryptoForexHoldingsPreSale(
        CryptoForexHoldings _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = CryptoForexHoldings(_token);
